...
INPUT_DIR = Path("data/processed/pipeline_A")
...
print("\n" + "=" * 60)
print("Pipeline A combined feature dataset complete")
print("=" * 60)
...
print("\nPipeline A combined feature dataset test passed.")
